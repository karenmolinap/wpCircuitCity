...
class Cmsmasters_Content_Composer { 
	function __construct() { 
		define('CMSMASTERS_CONTENT_COMPOSER_VERSION', '2.3.5');
		...
		if (
			...
			($pagenow == 'post-new.php' && isset($_GET['post_type']) && $_GET['post_type'] != 'cmsmasters_font') || 
			($pagenow == 'post.php' && isset($_GET['post']) && get_post_type($_GET['post']) != 'attachment' && get_post_type($_GET['post']) != 'cmsmasters_font') 
		) {
